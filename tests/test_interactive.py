...
def rendered_of(message) -> str:
    """Bubble plus card, which together are what the student actually sees.

    Content moves between the two as cards absorb what the text used to say,
    so a test that pins which half a phrase lands in breaks on every layout
